...
Examining the names visually we can see that some users used their name to communicate a message, instead of their identities!
...
Perhaps their ***really is*** a Mr Fixit?
